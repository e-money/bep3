...
func (*QueryAssetSupply) Descriptor() ([]byte, []int) {
	return fileDescriptor_b19747726e63bbb4, []int{0}
}
...
func (*QueryAtomicSwapByID) Descriptor() ([]byte, []int) {
	return fileDescriptor_b19747726e63bbb4, []int{1}
}
...
type QueryAtomicSwaps struct {
	Page       int64         `protobuf:"varint,1,opt,name=page,proto3" json:"page,omitempty" yaml:"page"`
	Limit      int64         `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty" yaml:"limit"`
...
func (*QueryAtomicSwaps) Descriptor() ([]byte, []int) {
	return fileDescriptor_b19747726e63bbb4, []int{2}
}
...
func (m *QueryAtomicSwaps) GetPage() int64 {
	if m != nil {
		return m.Page
	}
	return 0
...
func (m *QueryAtomicSwaps) GetLimit() int64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func init() { proto.RegisterFile("bep3/qry.proto", fileDescriptor_b19747726e63bbb4) }

var fileDescriptor_b19747726e63bbb4 = []byte{
	// 426 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *QueryAssetSupply) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Denom) > 0 {
		i -= len(m.Denom)
		copy(dAtA[i:], m.Denom)
		i = encodeVarintQry(dAtA, i, uint64(len(m.Denom)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *QueryAtomicSwapByID) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SwapID) > 0 {
		...
		i = encodeVarintQry(dAtA, i, uint64(len(m.SwapID)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *QueryAtomicSwaps) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Direction != 0 {
		i = encodeVarintQry(dAtA, i, uint64(m.Direction))
		i--
		dAtA[i] = 0x30
	}
	if m.Status != 0 {
		i = encodeVarintQry(dAtA, i, uint64(m.Status))
		i--
		dAtA[i] = 0x28
	}
	if m.Expiration != 0 {
		i = encodeVarintQry(dAtA, i, uint64(m.Expiration))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Involve) > 0 {
		...
		i = encodeVarintQry(dAtA, i, uint64(len(m.Involve)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Limit != 0 {
		i = encodeVarintQry(dAtA, i, uint64(m.Limit))
		i--
		dAtA[i] = 0x10
	}
	if m.Page != 0 {
		i = encodeVarintQry(dAtA, i, uint64(m.Page))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func encodeVarintQry(dAtA []byte, offset int, v uint64) int {
	offset -= sovQry(v)
	base := offset
	for v >= 1<<7 {
...
func (m *QueryAtomicSwaps) Size() (n int) {
	...
	_ = l
	if m.Page != 0 {
		n += 1 + sovQry(uint64(m.Page))
	}
	if m.Limit != 0 {
		n += 1 + sovQry(uint64(m.Limit))
	}
	l = len(m.Involve)
	if l > 0 {
		n += 1 + l + sovQry(uint64(l))
	...
	if m.Expiration != 0 {
		n += 1 + sovQry(uint64(m.Expiration))
	}
	if m.Status != 0 {
		n += 1 + sovQry(uint64(m.Status))
	}
	if m.Direction != 0 {
		n += 1 + sovQry(uint64(m.Direction))
	}
	return n
}

func sovQry(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}

func sozQry(x uint64) (n int) {
	return sovQry(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func skipQry(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupQry
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthQry        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowQry          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupQry = fmt.Errorf("proto: unexpected end of group")
)
